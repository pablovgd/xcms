...
during peak picking by setting `verboseBetaColumns = TRUE`, or they can be 
calculated afterwards by using the `chromPeakSummary` function with the object 
and `BetaDistributionParam` as input.
...
Using summary statistics, one can get a better idea of the distribution of 
